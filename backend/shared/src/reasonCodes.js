...
const REASON_CODES = Object.freeze({
  LIVENESS_EVIDENCE_INSUFFICIENT: "LIVENESS_EVIDENCE_INSUFFICIENT",
  LIVENESS_IDENTITY_UNAVAILABLE: "LIVENESS_IDENTITY_UNAVAILABLE",
  LIVENESS_POLICY_UNVERIFIED: "LIVENESS_POLICY_UNVERIFIED",
  ...
  LIVENESS_POSE_UNAVAILABLE: "LIVENESS_POSE_UNAVAILABLE",
  LIVENESS_FRAME_BINDING_FAILED: "LIVENESS_FRAME_BINDING_FAILED",
  LIVENESS_MOTION_UNVERIFIED: "LIVENESS_MOTION_UNVERIFIED",
  LIVENESS_DIRECTION_INCONSISTENT: "LIVENESS_DIRECTION_INCONSISTENT",
  LIVENESS_MANUAL_CAPTURE: "LIVENESS_MANUAL_CAPTURE",
  LIVENESS_IDENTITY_MISMATCH: "LIVENESS_IDENTITY_MISMATCH",
  LIVENESS_IDENTITY_BORDERLINE: "LIVENESS_IDENTITY_BORDERLINE",
  FACE_OCCLUDED: "FACE_OCCLUDED",
  LIVENESS_POSE_PROVIDER_UNAVAILABLE: "LIVENESS_POSE_PROVIDER_UNAVAILABLE",
  LIVENESS_FLAT_OBJECT: "LIVENESS_FLAT_OBJECT",
  LIVENESS_FLASH_UNVERIFIED: "LIVENESS_FLASH_UNVERIFIED",
  MULTIPLE_FACES_DURING_CHALLENGE: "MULTIPLE_FACES_DURING_CHALLENGE",
  LIVENESS_CHALLENGE_SEQUENCE_INVALID: "LIVENESS_CHALLENGE_SEQUENCE_INVALID",
  ...
  CAPTURE_INTEGRITY_RISK: "CAPTURE_INTEGRITY_RISK",
